...
public class Pharmacy {
    ...
    public Pharmacy(PharmacyOwner pharmacyOwner, String pharmacyname, String registrationnumber, String email, String phonenumber, String city, String street, String district) {
        super();
